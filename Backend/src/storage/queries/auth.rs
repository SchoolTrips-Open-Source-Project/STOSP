...
impl Auth {
    ...
    /// Implementation for find all the records by primary key.
    ...
    /// Implementation for find the record by mobile number.
    ...
    /// Implementation for find the record by primary key.
