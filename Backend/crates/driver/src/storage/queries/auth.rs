...
use crate::db::schema::school_trips_driver::auth::dsl;
use crate::db::schema::school_trips_driver::auth::{self};

use crate::{
    db::database::DBPool,
    storage::{models::auth::Auth, result},
};
...
impl Auth {
    ...
    pub fn get_by_mobile(key: String, conn: &DBPool) -> result::QueryResult<Option<Auth>> {
